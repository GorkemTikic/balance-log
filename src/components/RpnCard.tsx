...
import { gt, fmtAbs, fmtSigned } from "../lib/number";

type MapShape = Record<string, { pos: number; neg: number; net: number }>;

export default function RpnCard({ title, map }: { title: string; map: MapShape }) {
