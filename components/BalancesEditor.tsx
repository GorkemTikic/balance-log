// components/BalancesEditor.tsx
import React from "react";
import { ALL_ASSETS, AssetCode } from "../lib/types";
import { BalanceRow, emptyRow, pasteToRows } from "../lib/balance";
      ...
      {!readonly && (
        <div className="btn-row" style={{marginTop:6}}>
          ...
          <div className="btn-row">
            {ALL_ASSETS.map(a => (
              <button key={a} className="btn btn-small" onClick={()=>setRows([...rows, {asset:a as AssetCode, amount:""}])}>
                {a}
              </button>
            ))}
          </div>
